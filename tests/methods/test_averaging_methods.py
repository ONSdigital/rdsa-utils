...
class TestWeightedArithmeticAverage:
    ...
    def test_expected(self, input_df, create_spark_df):
        ...
        actual = (
            input_df
            .agg(weighted_arithmetic_average('price', 'weight')
            .alias('average'))
        )
...
class TestWeightedGeometricAverage:
    ...
    def test_expected(self, input_df, create_spark_df):
        ...
        actual = (
            input_df
            .agg(weighted_geometric_average('price', 'weight')
            .alias('average'))
        )
        expected = create_spark_df([
            ('average', ),
...
class TestWUnweightedArithmeticAverage:
    ...
    def test_expected(self, input_df, create_spark_df):
        ...
        actual = (
            input_df
            .agg(unweighted_arithmetic_average('price')
            .alias('average'))
        )
        expected = create_spark_df([
            ('average', ),
...
class TestWUnweightedGeometricAverage:
    ...
    def test_expected(self, input_df, create_spark_df):
        ...
        actual = (
            input_df
            .agg(unweighted_geometric_average('price')
            .alias('average'))
        )
        expected = create_spark_df([
            ('average', ),
