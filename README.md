...
`rdsa-utils` is a Python codebase built with Python 3.8 and higher, and uses `pyproject.toml` with `uv` for dependency management and packaging.
...
Add to your package's dependencies with `uv`:
